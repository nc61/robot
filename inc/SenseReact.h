...
#define XPOS_PILE_LEFT_LIMIT 110 
#define XPOS_PILE_RIGHT_LIMIT 210 
#define XPOS_PILE_CENTERED 160 
#define AREA_PILE_THRESH 50000
#define AREA_PILE_LOW 20000
#define AREA_PILE_CLOSE 1300000

#define XPOS_BIN_LEFT_LIMIT 140 
#define XPOS_BIN_CENTERED 150
#define XPOS_BIN_RIGHT_LIMIT 160
#define YPOS_BIN_CLOSE 115
#define AREA_BIN_THRESH 5000
#define AREA_BIN_LOW 100
#define AREA_BIN_CLOSE 25000
#define ORIENTATION_THRESHOLD 20
#define XPOS_BIN_ALIGN_RIGHT 40
#define XPOS_BIN_ALIGN_LEFT 260 
#define NTB_FWD_CYCLES 10
